        ...
        <tr>
            ...
            <td align="center" bgcolor="#f0f0f0" data-composer>
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%"
                    ...
                    <!-- lotus-header-2 -->
                    <tr>
                        <td align="center" bgcolor="#3253F6" class="container-padding">
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="center" class="center-text">
                                        <img style="width:190px;border:0px;display: inline!important;"
                                            src="{{ asset('assets/Email-4_Intro.png') }}" width="190" border="0"
                                            alt="intro">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        style="font-family:'Poppins',sans-serif;font-size:42px;line-height:52px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                            ...
                                            <tr>
                                                ...
                                                <![endif]-->
                                                    ...
                                                    <a href="{{ $actionUrl }}" target="_blank"
                                                        style="font-family:'Poppins',sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>{{ $actionText }}</span></a>
